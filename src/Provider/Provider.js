                        ...
                        <div className="row valign-wrapper">
                            <div className="col s12">
                                <table className="centered">
                                    <tbody>
                                      <tr>
                                        <td><b>Provider Rating</b><br/><i className="material-icons card-icon star-rate">star_rate</i><b>
                                            { providerRating }
                                        </b></td>
                                        <td>Communication<br/><i className="material-icons card-icon star-rate">star_rate</i><b>{ review.providerRating.communication }</b></td>
                                        <td>Management<br/><i className="material-icons card-icon star-rate">star_rate</i><b>{ review.providerRating.management }</b></td>
                                        <td>Integrity<br/><i className="material-icons card-icon star-rate">star_rate</i><b>{ review.providerRating.integrity }</b></td>
                                        <td>Reliability<br/><i className="material-icons card-icon star-rate">star_rate</i><b>{ review.providerRating.reliability }</b></td>
                                        <td>Availability<br/><i className="material-icons card-icon star-rate">star_rate</i><b>{ review.providerRating.availability }</b></td>
                                      </tr>
                                      <tr>
                                        <td><b>Service Rating</b><br/><i className="material-icons card-icon star-rate">star_rate</i><b>
                                            { serviceRating }
                                        </b></td>
                                        <td>Timeliness<br/><i className="material-icons card-icon star-rate">star_rate</i><b>{ review.serviceRating.timeliness }</b></td>
                                        <td>Quality<br/><i className="material-icons card-icon star-rate">star_rate</i><b>{ review.serviceRating.quality }</b></td>
                                        <td>Costs<br/><i className="material-icons card-icon star-rate">star_rate</i><b>{ review.serviceRating.costs }</b></td>
                                      </tr>
                                    </tbody>
                                  </table>
                            </div>
